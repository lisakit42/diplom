      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={<BethovenLunnayaSonata />}
          />
          <Route
            path="/catalog/mozartpianoconcerto21/"
            element={<MozartPianoConcerto21 />}
          />
          <Route
            path="/catalog/gaspariniadoramuste/"
            element={<GaspariniAdoramusTe />}
          />
          <Route
            path="/catalog/beethovenfurelise/"
            element={<BeethovenFurElise />}
          />
          <Route
            path="/catalog/chaykovskyswanlake/"
            element={<ChaykovskySwanLake />}
          />
          <Route
            path="/catalog/chaykovskyvremenagoda/"
            element={<ChaykovskyVremenaGoda />}
          />
          <Route
            path="/catalog/boccherinisonatag5/"
            element={<BoccheriniSonataG5 />}
          />
          <Route
            path="/catalog/brahmsHungariandance5/"
            element={<BrahmsHungarianDance5 />}
          />
          <Route
            path="/catalog/mocartMalenkayanochnayaserenada/"
            element={<MocartMalenkayaNochnayaSerenada />}
          />
          <Route
            path="/catalog/rachmaninovpianoconcerto2/"
            element={<RachmaninovPianoConcerto2 />}
          />
