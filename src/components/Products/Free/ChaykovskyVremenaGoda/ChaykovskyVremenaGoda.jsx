...
import "./ChaykovskyVremenaGoda.scss";
import MainPic from "../../../upload/catalogPics/tchaikovsky-vremena-goda.jpg";
import Like from "../../../upload/fav.svg";
import CatalogCarousel from "../../../CatalogCarousel/CatalogCArousel";

const ChaykovskyVremenaGoda = () => {
        ...
        <>
            <div className="MainPartCatalog">
                ...
                <div className="MainDecription">
                    <h2>
                        <b>Пётр Ильич Чайковский</b> - Времена года
                    </h2>
                    <br />
...
export default ChaykovskyVremenaGoda;
