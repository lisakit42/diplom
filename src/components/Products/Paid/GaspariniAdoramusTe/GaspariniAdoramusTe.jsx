...
import "./GaspariniAdoramusTe.scss";
import MainPic from "../../../upload/catalogPics/gasparini-adoramus.jpg";
import Like from "../../../upload/fav.svg";
import CatalogCarousel from "../../../CatalogCarousel/CatalogCArousel";

const GaspariniAdoramusTe = () => {
        ...
        <>
            <div className="MainPartCatalog">
                ...
                <div className="MainDecription">
                    <h2>
                        <b>Франческо Гаспарини</b> - Адорамус те
                    </h2>
                    <br />
...
export default GaspariniAdoramusTe;
